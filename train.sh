...
./scripts/run_finetune_with_qlora.sh --deepspeed_args "--include=localhost:0,2 --master_port=11000" --config configs/moss-pt-qlora.json
#./scripts/run_finetune_with_qlora.sh --deepspeed_args "--include=localhost:0,1,3,4 --master_port=11000" --config configs/baichuan-7b-pt-qlora.json
