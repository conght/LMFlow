...
print('loading model')
model = AutoModelForCausalLM.from_pretrained(args.model_path, quantization_config=q_config, device_map="auto", trust_remote_code=True)print('loading peft model')
